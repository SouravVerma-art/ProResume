...
import { BriefcaseBusiness, Globe, Linkedin, Mail, Phone, Pin, User, Github } from "lucide-react";
...
const PersonalInfoForm = ({ data, onChange }) => {
  ...
  const fields = [
    ...
    { key: "location", label: "Location", icon: Pin, type: "text" },
          ...
          return (
            <div key={field.key} className='space-y-1 mt-5'>
              ...
              <input
                ...
                placeholder={data[field.key] || `Enter your ${field.label.toLowerCase()}`}
